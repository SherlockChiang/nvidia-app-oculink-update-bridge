...
set "bridge_script=%~dp0Uninstall-NvidiaAppOculinkShim.ps1"
if not exist "%bridge_script%" set "bridge_script=%~dp0..\Uninstall-NvidiaAppOculinkShim.ps1"
if not exist "%bridge_script%" (
  echo Required installer script Uninstall-NvidiaAppOculinkShim.ps1 was not found.
